**_Задание 2:_**  *Среди наших продуктов есть портал, позволяющий пациенту записаться на приём в медицинскую организацию, оплатить услуги, получить доступ к своему протоколу и т.д.
